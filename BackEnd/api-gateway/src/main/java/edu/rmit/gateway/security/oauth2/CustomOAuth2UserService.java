...
import edu.rmit.gateway.security.UserPrincipal;
import edu.rmit.gateway.security.oauth2.user.OAuth2UserInfo;
import edu.rmit.gateway.security.oauth2.user.OAuth2UserInfoFactory;
...
public class CustomOAuth2UserService extends DefaultOAuth2UserService {
    ...
    private OAuth2User processOAuth2User(OAuth2UserRequest oAuth2UserRequest, OAuth2User oAuth2User) {
        ...
        Optional<User> userOptional = userRepository.findByEmailIgnoreCase(oAuth2UserInfo.getEmail());
        User user;
